...
class anamnesi
{
	...
	private $propositosConseguir;
	private $motivoAcudir;
	private $dietasAnteriores;
	private $oscilacionesPeso;
	private $supusoEsfuerzo;
	private $motivoAbandono;
	private $desdeDieta;
	private $tipoDieta;
	private $beneficiosPersonales;
	private $patologiasActuales;
	private $bioquimicosTG;
	private $glucosa;
	private $Fe;
	private $VCM;
	private $TSH;
	private $transaminasas;
	private $Urea;
	private $creatina;
	private $colesterol;
	private $restricciones;
	private $causasPatologicas;
	private $otrasPatologias;
	private $antecedentes;
	private $analitica;
	private $operaciones;
	private $causasOperaciones;
	private $tomasFarmacos;
	private $deposiciones;
	private $alergias;
	private $intolerancias;
	private $menstruacion;
	private $tiempoLibre;
	private $quienVives;
	private $quienCocina;
	private $actividadFisica;
	private $gustaHacer;
	private $pondriaProposito;
	private $dedicas;
	private $horario;
	private $desplazamiento;
	private $dondeCome;
	private $horasDuerme;
	private $habitosToxicos;
	private $desayuno;
	private $almuerzo;
	private $comida;
	private $merienda;
	private $cena;
	private $cuestionarioFrecuencia;
	private $preferencia;
	private $aversiones;
	private $picoteo;
	private $cuantasVecesPicas;
	private $cantidadPicas;
	private $comesFuera;
	private $cuantasVeces;
	private $tipoComida;
	private $motivoComesFuera;
	private $repitesPlato;
	private $tiempoComer;
	private $hacerCompra;
	private $gustaCocinar;
	private $mientrasComes;
	private $peso;
	private $talla;
	private $cintura;
	private $cadera;
